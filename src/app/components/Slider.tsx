...
const feedbacks = [
    ...
    },
    {
        ...
        username: '@rbrdesign',
        profile: rbr,
        resume: `Quando entrei para a comunidade, estava passando por uma fase de insegurança em relação à aplicabilidade do branding nos meus projetos. Apesar de participar de diversos cursos e palestras sobre o assunto, ainda me sentia frustrada e desorientada. `,
        content: `No entanto, ao chegar na comunidade, fui recebida com tanto acolhimento e disposição para ajudar que me senti em casa. Devorei o conteúdo rapidamente e finalmente comecei a compreender os verdadeiros objetivos da estratégia de marca e como ela poderia impactar positivamente nos projetos dos meus clientes.
