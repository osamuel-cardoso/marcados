import { GetPostData, GetPostsData } from '@/@types/blog'
...
import { PostGrid } from '../../components/PostGallery'
...
export default async function Page({
    ...
    const { blogPosts }: GetPostsData = postsData
                        ...
                        <div className="flex flex-col gap-10 pb-6 border-b border-brand__gray-900">
                            ...
                            <div className="flex justify-between items-center">
                                ...
                                <div className="flex gap-2">
                                    <Link
                                        href={
                                            'https://www.youtube.com/@AndreLona'
                                        }
                                        target="_blank"
                                    >
                                        <svg
                        ...
                        <div className="w-full flex flex-col gap-6 text-brand__gray-300">
                            <RichText
                                ...
                                renderers={{
                                    ...
                                    code_block: ({ children }) => {
                                        return (
                                            <div className="pb-6 border-b border-brand__gray-900">
                                                <code className="block p-5 bg-brand__gray-950 rounded-xl text-[1.0625rem]">
                                                    {children}
                                                </code>
                                            </div>
                                        )
                        ...
                        <div className="pb-4 border-b border-solid border-brand__gray-900">
                            <div className="flex justify-between">
                                <div className="flex gap-1">
                                    <h3 className="uppercase text-[1.3125rem]">
                                        Continue lendo
                                    </h3>
                                </div>
                                <Link href={'/articles'}>
                                    <span className="uppercase font-bold text-[.9375rem]">
                                        Ver mais →
                                    </span>
                                </Link>
                            </div>
                        </div>
                        <div className="border-b border-brand__gray-900 pb-10">
                            {blogPosts.map(
                                (
                                    {
                                        slug,
                                    ...
                                    <div
                                        className="grid lg:grid-cols-3 lg:gap-x-4 lg:gap-y-10"
                                        key={index}
                                    >
                                        <PostGrid
                                            key={index}
